...
const BookingExtraSchema = new mongoose.Schema(
  {
    ...
    managementGross: { type: Number, default: 0 },
    refundableDeposit: { type: Boolean, default: false },
...
const ExtrasAccountingSchema = new mongoose.Schema(
  {
    ...
    passThroughGross: { type: Number, default: 0 },
    managementGross: { type: Number, default: 0 },
    managementNet: { type: Number, default: 0 },
    managementVat: { type: Number, default: 0 },
    refundableDepositGross: { type: Number, default: 0 },
