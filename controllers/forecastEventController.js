...
export const deleteForecastEvent = async (req, res) => {
  try {
    ...
    if (forecastEvent.isAutoGenerated) {
      return res.status(400).json({
        success: false,
        message:
          "Auto-generated forecast events should be updated from the booking forecast, not deleted manually.",
      });
    }
    ...
    res.json({
      success: true,
      message: "Forecast event deleted",
    });
  } catch (error) {
