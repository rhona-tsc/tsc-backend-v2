...
forecastEventRouter.post("/bulk-supplier-payouts-csv", async (req, res) => {
  try {
    const body = req.body || {};
    ...
    const entity =
      typeof body === "object" && body.entity ? body.entity : "BMM";

    const replaceExisting =
      typeof body === "object" ? Boolean(body.replaceExisting) : false;
